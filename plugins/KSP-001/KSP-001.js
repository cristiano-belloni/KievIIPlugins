define(['kievII', 'require'], function(
      ...
      console.log ("***SP: ", require.toUrl('./assets/images/keyblack.png'));
      var pluginRequire = require;
        ...
        var initPlugin = function(args) {
            ...
            function (keyBlackImg, keyWhiteImg, keyBlackDownImg, keyWhiteDownImg, deckImg) {
